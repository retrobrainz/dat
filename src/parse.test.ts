...
describe('parse()', () => {
  it('parses key-value pairs from .dat content', async () => {
    ...
    expect(result).toEqual([
      ...
      },
      {
        ...
        $entries: [
          {
            $class: 'rom',
            name: 'Aa Harimanada (Japan).gg',
            size: '524288',
            crc: '1D17D2A0',
            md5: 'DA0523E29F893FB81E5F2E89B2FB240A',
      ...
      },
      {
        ...
        $entries: [
          {
            $class: 'rom',
            name: 'Adventures of Batman & Robin, The (USA, Europe, Brazil) (En).gg',
            size: '524288',
            crc: 'BB4F23FF',
      ...
      {
        $class: 'game',
        name: 'Adventures of Batman & Robin, The (USA, Europe, Brazil) (En) (Beta)',
        releaseyear: '1995',
        releasemonth: '04',
        releaseday: '27',
        region: 'USA',
        $entries: [
          {
            $class: 'rom',
            name: 'Adventures of Batman & Robin, The (USA, Europe, Brazil) (En) (Beta) (1995-04-27).gg',
            size: '524278',
            crc: 'ACCE0D15',
            md5: '5913EC1BBC095860334F5857D43FF047',
